...
function Show-FolderBrowserDialog {
    ...
    $folderBrowser.Description = "Select the installation folder for RedFree Windows Optimizer"
...
function Install-RedFreeWindowsOptimizer {
    if (-not $textBox.Text) {
    ...
    # Set variables
    $repo = "RedXUK/RedFree-Windows-Optimizer"
    $file = "RedFree-Windows-Optimizer.zip"
    $targetDir = $textBox.Text
    $shortcutName = "RedFree Windows Optimizer"
    ...
    $executablePath = Join-Path $targetDir "RedFree-windows-optimizer\RedFree windows optimizer.exe"
    ...
    $shortcut.WorkingDirectory = Join-Path $targetDir "RedFree-windows-optimizer"
    $shortcut.Save()

    # Display a success message
    [System.Windows.Forms.MessageBox]::Show("The latest release of RedFree Windows Optimizer has been successfully downloaded and installed.", "Installation Complete", [System.Windows.Forms.MessageBoxButtons]::OK, [System.Windows.Forms.MessageBoxIcon]::Information)
}

# Create the main window
$form = New-Object System.Windows.Forms.Form
$form.Text = "RedFree Windows Optimizer Installer"
...
$buttonInstall.Add_Click({
    $progressBar.Value = 0
    $form.Update()
    Install-RedFreeWindowsOptimizer
