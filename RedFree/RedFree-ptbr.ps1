...
$Ask = 'O seguinte permitirá que você desbloqueie o Windows 10 ou reverta as alterações feitas após o desbloqueio do Windows 10.

        Select "Sim" para desbloquear o Windows 10

        Select "Não" para reverter alterações feitas por este scriptt
        
        Select "Cancelar" para interromper o script.'

$EverythingorSpecific = "Gostaria de remover tudo o que está pré-instalado em sua máquina Windows? Selecione Sim para remover tudo ou selecione Não para remover aplicativos por meio de uma lista negra."
$EdgePdf = "Você deseja impedir que o Edge assuma o papel de visualizador de PDF padrão?"
$EdgePdf2 = "Deseja reverter as alterações que desativaram o Edge como visualizador de PDF padrão?"
$Reboot = "Para que algumas das alterações tenham efeito adequado, é recomendável reiniciar sua máquina. Você gostaria de reiniciar?"
$OneDriveDelete = "Quer desinstalar o One Drive?"
$Unpin = "Deseja desafixar todos os itens do menu Iniciar?"
$InstallNET = "Deseja instalar o .NET 3.5?"
$LastUsedFilesFolders = "Deseja ocultar os últimos arquivos e pastas usados ​​no Explorer?"
$LastUsedFilesFolders2 = "Deseja mostrar os últimos arquivos e pastas usados ​​no Explorer?"
$ClearLastUsedFilesFolders = "Deseja limpar os últimos arquivos e pastas usados?"
$AeroShake = "Deseja desativar o AeroShake?"
$AeroShake2 = "Deseja reativar o AeroShake?"
